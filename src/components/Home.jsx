...
import { RiDownload2Line } from "react-icons/ri"; // Import the download icon
import ProfilePic from "../assets/pro.jpg"; // Ensure you have a profile picture in the specified path
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col md:flex-row items-center h-full space-y-8 md:space-y-0 md:space-x-8">
        ...
        <div className="flex flex-col justify-center h-full text-center md:text-left">
          ...
          <motion.p
            ...
            className="text-[#8892b0] py-4 max-w-[700px] mx-auto md:mx-0"
          >
          ...
          >
            <Link
              ...
              smooth={true}
              duration={500}>
              <button className="text-white group border-2 sm:border-pink-600 px-6 py-3 my-2 flex items-center mx-auto md:mx-0 lg:hover:bg-pink-600 lg:hover:border-pink-600">
                View Work
            ...
            <a
              href={Tony}
              download
              className="text-white group border-2 sm:border-pink-600 px-6 py-3 my-2 flex items-center mx-auto md:mx-0 lg:hover:bg-pink-600 lg:hover:border-pink-600"
            >
